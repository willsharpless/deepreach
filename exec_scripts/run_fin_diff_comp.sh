...
# # DeepReach/PINN baseline
# python run_experiment.py $base_args $nlin_sys_args --baseline --num_epochs 100000 --experiment_name LL${N}D_DR $use_wandb --wandb_project $wandb_project --wandb_name LL${N}D_DR
