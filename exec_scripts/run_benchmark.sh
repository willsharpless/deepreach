...
readonly supervisor="./linear_supervisors/LL50D_DR_linear_r25_light"
...
# readonly method_args="--dynamics_class LessLinearNDlambda --hopf_loss lin_val_grad_diff --load_hopf_model --load_hopf_model_name $supervisor --zerolambda_LS --LS_w_time_curr --hopf_pretrain_iters 1 --hopf_loss_divisor 1000 --hopf_grad_loss_divisor 4000"
# readonly method_args="--dynamics_class LessLinearNDlambda --hopf_loss lin_val_grad_diff --load_hopf_model --load_hopf_model_name $supervisor --zerolambda_LS --LS_w_time_curr --hopf_pretrain_iters 1 --hopf_loss_divisor 500 --hopf_grad_loss_divisor 4000"

FIXME: #add self adjusted flags here, I named all the subsequent experiments "AUTOTUNE"
readonly method_args="--dynamics_class LessLinearNDlambda --hopf_loss lin_val_grad_diff --load_hopf_model --load_hopf_model_name $supervisor --zerolambda_LS --LS_w_time_curr --hopf_pretrain_iters 1 --hopf_loss_divisor 500 --hopf_grad_loss_divisor 1000"
...
wandb_name="--wandb_name ZLLS_hld1k_hgld4k_50D_300k_b2"
...
name="ZLLS_AUTOTUNE_50D_300k_b3"
experiment_name="--experiment_name $name"
wandb_name="--wandb_name ZLLS_AUTOTUNE_50D_300k_b3"
...
name="ZLLS_AUTOTUNE_50D_300k_b4"
experiment_name="--experiment_name $name"
wandb_name="--wandb_name ZLLS_AUTOTUNE_50D_300k_b4"
...
cd $summary_dir_name
jq -s '.' wandb-summary_b2.json wandb-summary_b3.json wandb-summary_b4.json > benchmark_tally.json