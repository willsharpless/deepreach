...
# Save
# np.savez_compressed("Conoe2D_base_params.npz", times=times, lbs=lbs, ubs=ubs, grid_pad=grid_pad, grid_L=grid_L)

reduced_type = np.float16
np.savez_compressed("Canoe2D_BRRT_V1.npz", lbs=lbs, ubs=ubs, grid_pad=grid_pad, grid_L=grid_L, 
                    V1=reach_values_1.astype(reduced_type))

np.savez_compressed("Canoe2D_BRRT_V2.npz", lbs=lbs, ubs=ubs, grid_pad=grid_pad, grid_L=grid_L, 
                    V2=reach_values_2.astype(reduced_type))

np.savez_compressed("Canoe2D_BRRT_V.npz", lbs=lbs, ubs=ubs, grid_pad=grid_pad, grid_L=grid_L, 
                    V=reach_values_stat.astype(reduced_type))

np.savez_compressed("Canoe2D_BRRT_V1_tv.npz", lbs=lbs, ubs=ubs, grid_pad=grid_pad, grid_L=grid_L, 
                    V1=reach_values_1_tv.astype(reduced_type))

np.savez_compressed("Canoe2D_BRRT_V_tv.npz", lbs=lbs, ubs=ubs, grid_pad=grid_pad, grid_L=grid_L, 
                    V=reach_values_tv.astype(reduced_type))
