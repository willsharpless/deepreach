...
class ReachabilityDataset(Dataset):
    def __init__(self, dynamics, numpoints, pretrain, pretrain_iters, tMin, tMax, counter_start, counter_end, num_src_samples, num_target_samples, 
                 super_pretrain=False, super_pretrain_iters=0, record_gt_metrics=False, solve_grad=False,
                 no_curriculum=False, capacity_test=False,
                 lambda_var=False, LS_w_time_curr=False,
